...
export interface CppConnectionAutogen {
    ...
    managementSearchIndexStats(options: CppManagementSearchIndexStatsRequest, callback: (err: CppError | null, result: CppManagementSearchIndexStatsResponse) => void): void;
...
export declare type CppErrc = CppErrcCommon | CppErrcKeyValue | CppErrcQuery | CppErrcAnalytics | CppErrcSearch | CppErrcView | CppErrcManagement | CppErrcFieldLevelEncryption | CppErrcNetwork;
